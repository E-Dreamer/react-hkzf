...
export default class RentAdd extends Component {
  ...
  // 封装函数 用来处理 页面change选择的值
  getValue = (name, value) => {
    // console.log(name,value);
    // [name] 是es6的属性名表达式 直接拿对象动态的属性名
    this.setState({
      [name]: value,
    });
  };
  ...
  addHouse = async () => {
    ...
    if(res.data.status === 200){
        ...
        Toast.info('服务器偷懒了,请稍后再试~',1,null,false);
    }
  };
  render() {
    ...
    return (
      <div className={styles.root}>
        ...
        <List
          ...
          data-role="rent-list"
        >
          <HousePackge select onSelect={this.HousePackgeSelect} />
        </List>
